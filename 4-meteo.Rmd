...
c2020 %>%
  ...
  geom_text(data = bal, aes(x = as.Date(date), y=Inf, label = bal), 
            vjust = 2, hjust = -1, fontface = "italic", size=3)+
  theme_dens

ggsave(file = "plots/lluvias.png", w=80, h=50, units="mm", dpi=300, scale=2)
drive_upload(path = as_dribble("fina_2020/NOVA"), "plots/lluvias.png", overwrite = FALSE)
...
camp %>% 
  ...
  theme_dens
ggsave(file = "plots/temp.png", w=70, h=50, units="mm", dpi=300, scale=2)
drive_upload(path = as_dribble("fina_2020/NOVA"), "plots/temp.png", overwrite = FALSE)
```
